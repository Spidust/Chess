  ...
  if (board[team + "castle"] && !isChecking(board.board, team, pos)) {
    ...
    if (board[team + "Kside"]) {
      ...
      if (
        b[t][5] == "00" &&
        b[t][6] == "00" &&
        !isChecking(board.board, team, [t, 5] && !isChecking(board.board, team, [t, 6]))
      ) {
        valid.push([t, 6]);
      }
    }
    if (board[team + "Qside"]) {
      ...
      if (
        ...
        b[t][2] == "00" &&
        b[t][1] == 0 &&
        !isChecking(board.board, team, [t, 3]) &&
        !isChecking(board.board, team, [t, 2]) &&
        !isChecking(board.board, team, [t, 1])
      ) {
        valid.push([t, 2]);
      }
    }
